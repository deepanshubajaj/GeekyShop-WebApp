...
class Home extends Component<Props, State> {
  ...
  fetchInventory = async () => {
    try {
      const response = await fetch(`${baseApiUrl}/get-products`);
  ...
  handleSaveRecord = async () => {
    ...
    try {
      const response = await fetch(`${baseApiUrl}/save-product`, {
        method: "POST",
        body: formData,
      });
  ...
  handleDeleteRecord = async (fullId: string) => {
    ...
    try {
      const response = await fetch(`${baseApiUrl}/delete-product`, {
        method: "DELETE",
        headers: {
